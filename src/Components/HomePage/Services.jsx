     ...
     return (
          <div className='text-slate-900 mt-6 '>
               <div className='text-center container space-y-2 mx-auto'>
                    ...
                    <p className='w-1/2 mx-auto'> the majority have suffered alteration in some form, by injected humour, or randomised words which don not look even slightly believable.  </p>
               </div>
